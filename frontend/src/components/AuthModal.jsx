...
export default function AuthModal() {
    ...
    return (
        <>
            ...
            {/* Modal Overlay */}
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center modal-overlay bg-opacity-50">
                    <div className="bg-white rounded-lg w-full max-w-md mx-4 relative overflow-hidden">
                        ...
                        <div className="flex border-b mb-6">
                            <button
                                className={`flex-1 py-3 font-medium text-center ${activeTab === "login" ? "text-teal-700 border-b-2 border-teal-700" : "text-gray-500"
                                    }`}
                            ...
                            <button
                                className={`flex-1 py-3 font-medium text-center ${activeTab === "register" ? "text-teal-700 border-b-2 border-teal-700" : "text-gray-500"
                                    }`}
                                ...
                                <div className="mb-4">
                                    <div className="flex items-center text-sm mb-2">
                                        ...
                                        <div className="flex border rounded-md overflow-hidden">
                                            <button
                                                type="button"
                                                className={`px-4 py-1 text-sm ${loginMethod === "password" ? "bg-teal-700 text-white" : "bg-white text-gray-700"
                                                    }`}
                                            ...
                                            <button
                                                type="button"
                                                className={`px-4 py-1 text-sm ${loginMethod === "otp" ? "bg-teal-700 text-white" : "bg-white text-gray-700"
                                                    }`}
                                    ...
                                    {loginMethod === "password" ? (
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                id="otp"
                                                className={`w-full px-3 py-2 border ${errors.otp ? "border-red-500" : "border-gray-300"
                                                    } rounded-md focus:outline-none focus:ring-1 focus:ring-teal-500`}
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="text"
                                            id="fullName"
                                            className={`w-full pl-10 pr-3 py-2 border ${errors.fullName ? "border-red-500" : "border-gray-300"
                                                } rounded-md focus:outline-none focus:ring-1 focus:ring-teal-500`}
