            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-9xl mx-auto">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="relative group border-t-4 border-[#0c4244] border bg-white p-8 rounded-xl hover:shadow-[0_8px_30px_rgb(0,0,0,0.1)] transition-transform duration-500 overflow-hidden flex flex-col items-center justify-center text-center hover:-translate-y-3"
                        >
                            {/* Gradient overlay */}
